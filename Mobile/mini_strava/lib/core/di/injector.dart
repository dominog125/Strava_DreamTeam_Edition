...
import 'package:mini_strava/features/profile/data/datasources/profile_remote_data_source.dart';
...
import 'package:mini_strava/features/profile/domain/usecases/delete_avatar_usecase.dart';
import 'package:mini_strava/features/profile/domain/usecases/get_avatar_usecase.dart';
import 'package:mini_strava/features/profile/domain/usecases/upload_avatar_usecase.dart';
...
void setupInjector(SharedPreferences prefs) {
  ...
  sl.registerLazySingleton<GetCachedTokensUseCase>(() => GetCachedTokensUseCase(sl<AuthRepository>()));
  ...
  sl.registerLazySingleton<GetAvatarUseCase>(() => GetAvatarUseCase(sl<ProfileRepository>()));
  sl.registerLazySingleton<UploadAvatarUseCase>(() => UploadAvatarUseCase(sl<ProfileRepository>()));
  sl.registerLazySingleton<DeleteAvatarUseCase>(() => DeleteAvatarUseCase(sl<ProfileRepository>()));
  ...
  sl.registerLazySingleton<SaveActivityUseCase>(() => SaveActivityUseCase(sl<ActivityRepository>()));
  ...
  sl.registerLazySingleton<GetActivityHistoryUseCase>(
  ...
  sl.registerLazySingleton<AddManualActivityUseCase>(
        () => AddManualActivityUseCase(sl<ActivityHistoryRepositoryImpl>()),
  );
  sl.registerLazySingleton<UpdateActivityMetaUseCase>(
  ...
  sl.registerLazySingleton<DeleteFriendUseCase>(() => DeleteFriendUseCase(sl<FriendsRepository>()));
}
