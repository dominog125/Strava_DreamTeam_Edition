...
return [
    'login_panel_title' => 'Panel logowania',
    'login_panel_subtitle' => 'Wpisz swój login i hasło, aby przejść do panelu administratora.',
    'login' => 'Login',
    'password' => 'Hasło',
    'sign_in' => 'Zaloguj się',

    'admin_panel_kicker' => 'PANEL ADMINISTRATORA',
    'admin_home_title' => 'Strona Główna',
    'admin_users_title' => 'Użytkownicy',
    'admin_activities_title' => 'Aktywności',

    'nav_dashboard' => 'Strona główna',
    'nav_dashboard_abbr' => 'S',
    'nav_users' => 'Użytkownicy',
    'nav_users_abbr' => 'U',
    'nav_activities' => 'Aktywności',
    ...
    'no_activities_message' => 'Brak aktywności dla wybranych filtrów.',

    'filter_user' => 'Użytkownik',
    'date_from' => 'Data od',
    'date_to' => 'Data do',
    'distance_min_km' => 'Dystans min (km)',
